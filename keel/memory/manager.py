...
from keel.context.assembler import ContextItem
from keel.context.chunker import get_chunker
...
from keel.util import cosine, safe_json_loads
...
class MemoryManager:
    ...
    async def ingest_document(
        ...
        with current_tracer().span("memory.ingest", kind="memory", source=source, strategy=strategy) as span:
            ...
            from keel.context.chunker import chunk_stats
