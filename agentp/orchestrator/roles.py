...
from agentp.loop.engine import ReActEngine
from agentp.observability.trace import current_tracer
from agentp.orchestrator.graph import TaskGraph, TaskNode
from agentp.util import new_id, safe_json_loads
...
class Aggregator:
    ...
    async def aggregate(
        ...
        from agentp.orchestrator.graph import NodeStatus
